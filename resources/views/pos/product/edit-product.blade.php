        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
              <form action="{{route('product.update',$editdata->id)}}" method="POST" id="myfrom">
                    @csrf
                    <div class="form-row">
                       ...
                       <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                                <label for="name">Name:</label>
                                   <input type="text" class="form-control" id="name" placeholder="Enter producrt Name" value="{{$editdata->name}}"  name="name" required>
                                    @if ($errors->has('name'))
